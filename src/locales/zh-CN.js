export default {
  ...
  'menu.result': 'Results Statistic',
  'menu.trace': 'Response Trace',
  'menu.report': 'Response Report',
  'menu.energyAnalysis': 'Energy Analysis',
  'menu.energyConsumption': 'Energy Consumption',
